...
def test_solve_posterior():
    ...
    mu, Cu = solve_prior_covariance(A, b, fc, od, np.zeros(3))
    ...
    mu_full, Cu_full = solve_prior_covariance(A, b, fc, full_data, np.zeros(3))
...
def test_solve_prior_covariance_parallel(n_proc):
    ...
    mu, Cu = solve_prior_covariance(A, b, fc, od, np.zeros(3), my_ensemble.ensemble_comm)
